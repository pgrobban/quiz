...
type QuestionTag = 'Geography' | 'Music' | 'Words' | 'Currencies' | 'Chemistry' | 'Political leaders' | 'Nature' | 'One-word association' | 'Names' | 'Food & drinks' | "Space" | "Animals" | "Art" | "Fashion" | "Celebrities" | "Literature" | "History";
